## Project 6: Transactions, CMSC424, Spring 2020
...
explain this quite well: [https://docs.python.org/3/library/threading.html](Thread-based Parallelism in Python). Some basics:
...
Your task is to finish a few of the unfinished pieces in the two files (8 point for the first one, and 16 points each for the latter two).
